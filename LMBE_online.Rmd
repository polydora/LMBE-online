...
При работе с объектом (рак, креветка или изображение) надо найти и сфоткать на смартфон (ну или фотоаппарат в режиме *макро*) внешний вид животного. Подписать на объекте тагмы. Потом отделить и сфотографировать  А1, А2, ротовые конечности (Md, Mx1, Mx2, Mxp1, Vxp2, Mxp3), одну из ходных ног, одну из плеопод и уроподу. Фотки надо соединить в одну презентацию и присылать ее на адрес ВМ до 23:59 дня, накануне следующего занятия. 
